    ...
    <footer class="footer">
        <div class="footer__logo">
            ...
            <div class="footer__logo-links">
                <a href="www.twitter.com"><svg width="19" height="16" viewBox="0 0 19 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                ...
                <a href="www.linkedin.com" class="social-network-link"><svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
        ...
        <div class="footer__pages">
            ...
            <ul class="footer-list">
                ...
                <li><router-link to="project" class="router-link">Project</router-link></li>
                <li><router-link to="blog" class="router-link">Blog</router-link></li>
            </ul>
